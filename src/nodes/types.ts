...
export type AINode = Node<{ nodeName: string, onDataChange: (id: string, newData: string, dataType: string) => void, rawData: any, dataType: string, opType: string }, 'ai'>;
...
export type AppNode = DataNode | VizNode | TransformNode | AINode;